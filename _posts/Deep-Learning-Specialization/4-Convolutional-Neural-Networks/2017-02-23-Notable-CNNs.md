---
layout: post
title: Notable Convolutional Neural Network Case Studies
tags: Deep-Learning
mathjax: true
categories: Deep-Learning
excerpt: <p> This post looks at some landmark CNNs developed by various research groups over the years. These CNNs pioneered deep learning's dominance in computer vision with innovative architectures</p>
---

This post looks at some landmark CNNs developed by various research groups over the years. These CNNs pioneered deep learning's dominance in computer vision with innovative architectures.

Note: The vast majority of this post comes directly from [mbadry1's notes on GitHub](https://github.com/mbadry1/DeepLearning.ai-Summary/blob/master/4-%20Convolutional%20Neural%20Networks/Readme.md).

Also see [this post](https://adeshpande3.github.io/The-9-Deep-Learning-Papers-You-Need-To-Know-About.html) on 9 landmark deep learning research papers.
