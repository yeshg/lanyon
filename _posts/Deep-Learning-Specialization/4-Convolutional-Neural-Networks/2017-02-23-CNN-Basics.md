...
The following is from CS231n, and it has formulas for calculating the dimensions of layers in the CNN based on hyperparameters and the dimensions of previous layers:
